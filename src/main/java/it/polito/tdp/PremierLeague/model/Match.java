...
public class Match implements Comparable<Match>{
	...
	public int getNumeroReporter() {
		return numeroReporter;
	}

	public void aumentaNumeroReporter(int numeroReporter) {
		this.numeroReporter += numeroReporter;
	}
